...
<html lang="en">
  ...
  height: 60vh;
  min-height: 500px;
  background-image: url('projectsimg/project4/emekus3.jpg');
    ...
    <div class="row h-100 align-items-center">
      ...
      <br>
       ...
       <div class="container wow fadeInUp">
        <p>
        <a style="color:black;" href="/index.php"> Home </a> > <a style="color:black;" href="kadoplaza.php"> Kado Plaza Abuja </a>
        ...
        <h1 STYLE="COLOR:BLACK; FONT-WEIGHT:800;"> Kado Plaza Abuja </h1>
        <hr>
        
        <p> This proposed Mixed use development would house 30 lettable spaces of various sizes fully fitted with sate of art facilities.
 </p>
                ...
                <img src="projectsimg/project4/emekus3.jpg" class="img-fluid img-thumbnail">
