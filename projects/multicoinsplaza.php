...
<html lang="en">
  ...
  height: 60vh;
  min-height: 500px;
  background-image: url('projectsimg/project9/R1.jpg');
    ...
    <div class="row h-100 align-items-center">
      ...
      <br>
       ...
       <div class="container wow fadeInUp">
        <p>
        <a style="color:black;" href="/index.php"> Home </a> > <a style="color:black;" href="multicoinsplaza.php"> Multicoins Plaza Dei Dei Abuja
   </a>
        ...
        <h1 STYLE="COLOR:BLACK; FONT-WEIGHT:800;"> Multicoins Plaza Dei Dei Abuja </h1>
        <hr>
        
        <p> Is an ongoing Commercial development at the International Building Material Market at Dei Dei Abuja
 </p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-2">
                 <img src="projectsimg/project9/R1.jpg" class="img-fluid img-thumbnail"> 
            </div>
            
               <div class="col-md-4 mb-2">
                 <img src="projectsimg/project9/R2.jpg" class="img-fluid img-thumbnail"> 
            </div>
            
               <div class="col-md-4 mb-2">
                 <img src="projectsimg/project9/R22.jpg" class="img-fluid img-thumbnail"> 
            </div>
