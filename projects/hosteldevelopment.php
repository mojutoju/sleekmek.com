...
<html lang="en">
  ...
  height: 60vh;
  min-height: 500px;
  background-image: url('projectsimg/project1/3b.jpg');
    ...
    <div class="row h-100 align-items-center">
      ...
      <br>
       ...
       <div class="container wow fadeInUp">
        <p>
        <a style="color:black;" href="/index.php"> Home </a> > <a style="color:black;" href="hosteldevelopment.php"> Hostel Development Apete Ibadan </a>
        ...
        <h1 STYLE="COLOR:BLACK; FONT-WEIGHT:800;"> HOSTEL DEVELOPMENT APETE IBADAN </h1>
        <hr>
        
        <p> This a proposed Post graduate hostel for students of the prestigious Obafemi Awolowo University Ife.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-2">
                ...
                <img src="projectsimg/project1/1a.jpg" class="img-fluid img-thumbnail">
            </div>
            
            
            
            <div class="col-md-4 mb-2">
                  <img src="projectsimg/project1/2a.jpg" class="img-fluid img-thumbnail"> 
            </div>
            
            
            <div class="col-md-4 mb-2">
                   <img src="projectsimg/project1/3b.jpg" class="img-fluid img-thumbnail">
            </div>
