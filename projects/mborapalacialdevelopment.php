...
<html lang="en">
  ...
  height: 60vh;
  min-height: 500px;
  background-image: url('projectsimg/project10/p9.jpg');
    ...
    <div class="row h-100 align-items-center">
      ...
      <br>
       ...
       <div class="container wow fadeInUp">
        <p>
        <a style="color:black;" href="/index.php"> Home </a> > <a style="color:black;" href="mborapalacialdevelopment.php"> Mbora Palatial Development
   </a>
        ...
        <h1 STYLE="COLOR:BLACK; FONT-WEIGHT:800;"> Mbora Palatial Development </h1>
        <hr>
        
        <p> A palace designed and developed for Royalty at the Mbora district of the FCT
 </p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-2">
                 <img src="projectsimg/project10/IMG-20190121-WA0013 (1).jpg" class="img-fluid img-thumbnail"> 
            </div>
            
               <div class="col-md-6 mb-2">
                 <img src="projectsimg/project10/IMG-20190119-WA0013 (2).jpg" class="img-fluid img-thumbnail"> 
            </div>
               ...
               <div class="col-md-6 mb-2">
                 <img src="projectsimg/project10/BATHROOM RENDERING!!!!!.jpg" class="img-fluid img-thumbnail"> 
            </div>
            
            
               <div class="col-md-6 mb-2">
                 <img src="projectsimg/project10/CAM LIVINGROOM.jpg" class="img-fluid img-thumbnail"> 
            </div>
