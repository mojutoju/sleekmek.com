...
<html lang="en">
  ...
  height: 60vh;
  min-height: 500px;
  background-image: url('projectsimg/project7/SLEEK.jpg');
    ...
    <div class="row h-100 align-items-center">
      ...
      <br>
       ...
       <div class="container wow fadeInUp">
        <p>
        <a style="color:black;" href="/index.php"> Home </a> > <a style="color:black;" href="luxuryflatsmpape.php">  Luxury Flats Mpape Abuja   </a>
        ...
        <h1 STYLE="COLOR:BLACK; FONT-WEIGHT:800;"> Luxury Flats Mpape Abuja </h1>
        <hr>
        
        <p> A proposed 3-bedroom block of flat fully services at the Mpape district of the FCT.
 </p>
        
                <img src="projectsimg/project7/SLEEK.jpg" class="img-fluid img-thumbnail">
